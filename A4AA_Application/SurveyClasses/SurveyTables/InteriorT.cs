...
namespace A4AA_Application.SurveyClasses.SurveyTables
{
	...
	{ 
		...
		public Question Int_door_open_clearance { get => int_door_open_clearance; set => int_door_open_clearance = value; }
		public Question Int_opening_measurment { get => int_opening_measurement; set => int_opening_measurement = value; }
		public Question Int_door_easy_open { get => int_door_easy_open; set => int_door_easy_open = value; }
		public Question Int_door_open_force { get => int_door_open_force; set => int_door_open_force = value; }
		public Question Int_door_use_with_fist { get => int_door_use_with_fist; set => int_door_use_with_fist = value; }
		public Question Five_second_close { get => five_second_close; set => five_second_close = value; }
		public Question Hallway_width { get => hallway_width; set => hallway_width = value; }
		public Question Narrowest_width { get => narrowest_width; set => narrowest_width = value; }
		public Question Wheelchair_turnaround { get => wheelchair_turnaround; set => wheelchair_turnaround = value; }
		public Question Hallway_obstacles { get => hallway_obstacles; set => hallway_obstacles = value; }
		public Question Hallway_clear { get => hallway_clear; set => hallway_clear = value; }
		...
		public Question Service_counter { get => service_counter; set => service_counter = value; }
		public Question Counter_height { get => counter_height; set => counter_height = value; }
		public Question Writing_surface_height { get => writing_surface_height; set => writing_surface_height = value; }
		public Question Drinking_fountain { get => drinking_fountain; set => drinking_fountain = value; }
