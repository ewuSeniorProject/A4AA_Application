...
namespace A4AA_Application.SurveyPages
{
	...
	public partial class SurveySectionG : ContentPage
	{
		private Survey theSurvey;

		private ArrayList QuestionLabels;
		private ArrayList QuestionAnswerSpaces;
		private EmergencyT Table;

		public SurveySectionG (Survey theSurvey)
		{
			this.theSurvey = theSurvey;
			InitializeComponent();
			Title = "Emergency Preparedness";

			var layout = this.FindByName<StackLayout>("theStackLayoutG");
